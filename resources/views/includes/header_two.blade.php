        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="/home" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="/settings/logo_white/{{ $setting->image }}" alt="" height="20">
                    </span>
                    <span class="logo-lg">
                        <img src="/settings/logo_white/{{ $setting->image }}" alt="" height="35">
                    </span>
                </a>
                @endforeach
            </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block ms-2">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    @if(auth()->user()->image) <!-- Check if the user has an uploaded image -->
...
<div id="loadingModal" class="modal" style="display: none;">
    <div class="modal-content">
        <p style="color: #04345e; font-size: 20px;">Switching Off...</p>
    </div>
</div>

<!-- Goodbye Modal -->
<div id="goodbyeModal" class="modal" style="display: none;">
    <div class="modal-content">
        <p style="color: #04345e; font-size: 20px;">Goodbye! Have a great day!</p>
    </div>
</div>
