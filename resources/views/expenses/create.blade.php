                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="row needs-validation" action="{{ route('expenses.store') }}" novalidate
                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <input type="text" name="expense_name" class="form-control"
                                                id="validationCustom01" placeholder="Enter Expense Name" required />
                                        ...
                                        {{-- <div class="mb-3 position-relative">
                                            ...
                                            <input type="text" name="expense_type" class="form-control"
                                                id="validationCustom01" placeholder="Enter Expense Type" required />
                                            <div class="valid-tooltip">
                                                Looks good!
                                            </div>
                                        </div> --}}
                                        ...
                                        <div>
                                            <select name="expense_type" parsley-type="url" type="text" class="form-select" placeholder="URL"
                                                required >
                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <div>
                                                <textarea name="expense_note" class="form-control" rows="5" required></textarea>
                                            </div>
                                        </div>
                                        <div class="mb-0">
                                            <div>
