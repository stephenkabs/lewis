                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title"><a class="btn btn-sm btn-info waves-effect waves-light"
                                            ...
                                            class="btn btn-info btn-sm waves-effect waves-light" href="/expenses/create"><i class="dripicons-plus"></i></a></h4>
                                    ...
                                    <div class="table-rep-plugin">
                                        <div class="table-responsive b-0" data-pattern="priority-columns">
                                            <table id="tech-companies-1" class="table table-striped">
                                                <thead>
                                                    <tr>
                                                        <th data-priority="1">Expense Name</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    @else
                                                        @foreach ($expense as $item)
                                                            <tr>
                                                                <td><b>{{ $item->expense_name }}</b><br>
                                                                    <span
                                                                        style="font-size: 11px; color:rgb(112, 112, 112);">Expense
                                                                        Type: {{ $item->expense_type }}</span>
                                                                    </td>
                                                                <td>
                                                                    ...
                                                                    color: {{ \Carbon\Carbon::parse($item->date_time)->isToday() ? 'red' : 'rgb(112, 112, 112)' }};">
                                                                      Date:
                                                                        {{ \Carbon\Carbon::parse($item->date_time)->format('F j, Y') }}
                                                                    </span>
                                                                <td>
                                                                    <b><a href="/expense/{{ $item->image }}" download>
                                                                            {{ $item->attachment_name ?? 'No File Name' }}
                                                                        </a></b>
                                                                    <br><span
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a class="btn btn-info waves-effect waves-light"
                                                                        href="{{ route('expenses.show', $item->slug) }}">
                                                                        <i class="dripicons-preview"></i>
                                                                    </a>
                                                                    <a class="btn btn-info waves-effect waves-light"
                                                                        id="sa-warning"
                                                                        href="{{ route('expenses.edit', $item->slug) }}">
                                                                    ...
                                                                    <button type="button"
                                                                        ...
                                                                        data-route="{{ route('expenses.destroy', $item->slug) }}">
