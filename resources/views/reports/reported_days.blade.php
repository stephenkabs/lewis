                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title"><a class="btn btn-sm btn-info waves-effect waves-light"
                                        ...
                                        <a class="btn btn-sm btn-info waves-effect waves-light"
                                            href="/payslip/create">Generate Payslips
                                        </a>
                                        <a class="btn btn-success btn-sm" href="{{ route('payslip.exportToExcel') }}">
                                            <i class="dripicons-download"></i> Export to Excel with Advances
                                        </a>

                                        <a class="btn btn-success btn-sm" href="{{ route('payslip_normal.exportToExcel') }}">
                                            <i class="dripicons-download"></i> Export to Excel Normal Pays
                                        </a>
                                        <a class="btn btn-success btn-sm" href="{{ route('reports.days.exportToExcel') }}">
                                            <i class="dripicons-download"></i> Export Attendance Data to Excel
                                        </a>


                                        {{-- <button id="downloadAllPayslips" class="btn btn-primary btn-sm">Download All
                                            Payslips</button> --}}
                                            ...
                                            <table id="tech-companies-1" class="table table-striped">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th data-priority="3">Prepared By</th>
                                                    </tr>
                                                </thead>
                                                <tbody id="table-body">
                                                    @if ($payslip->isEmpty())
                                                    ...
                                                    @else
                                                        @foreach ($payslip as $item)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <b>{{ $item->salary->worker->name }} ({{ $item->salary->worker->tracking_code  }})</b>
                                                                    <br>
                                                                    <span
                                                                        style="font-size: 11px; color:rgb(112, 112, 112);">
                                                                        Attendance Amount: {{ $item->worker->salary->daily_earnings * $item->worker->attendance->count() }}
                                                                    </span>
                                                                </td>
                                                                <td>
                                                                    <b>{{ $item->salary->worker->account_name }}</b>
                                                                    <br>
                                                                    <span
                                                                        style="font-size: 11px; color:rgb(112, 112, 112);">
                                                                        Acc No: {{ $item->worker->account_number }}
                                                                    </span>
                                                                </td>
