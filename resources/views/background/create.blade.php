                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">
                                        <a class="btn btn-info waves-effect waves-light"
                                            href="/departments"><i class="dripicons-arrow-thin-left"></i></a>
                                        </h4><br>


                                            <form class="row needs-validation" action="{{ route('background.store') }}"
                                          ...
                                          <div class="mb-3">
                                              ...
                                              <div class="mt-3">
                                                  <img id="imagePreview"
                                                       src="#"
                                                       alt="Preview"
                                                       style="display: none; width: 250px; height: 150px; border: 2px solid #1a1515; border-radius: 10px; object-fit: cover;" />
                                              </div>
                                          </div>
                                          ...
                                          <div class="mb-0">
                                              <div>
                                                  ...
                                                  <button type="reset" class="btn btn-secondary waves-effect ms-1" id="resetButton">
                                                      Cancel
                                                  </button>
                                              </div>
                                          </div>
