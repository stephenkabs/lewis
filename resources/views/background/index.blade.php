                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">
                                        <a class="btn btn-info btn-sm waves-effect waves-light" href="/background/create">
                                            <i class="dripicons-upload"></i> Upload Images
                                        </a>
                                    </h4>
                                    <p class="card-title-desc">Images are grouped by their type.</p>

                                    @foreach ($backgrounds->groupBy('type') as $type => $images)
                                        <div class="mb-4">
                                            <h5 class="text-primary">{{ ucfirst($type) }}</h5>
                                            <div class="row">
                                                @foreach ($images as $image)
                                                    <div class="col-md-3 mb-3">
                                                        <div class="card">
                                                            <img src="{{ asset('background_images/' . $image->image) }}"
                                                                 alt="{{ $image->type }}"
                                                                 class="card-img-top image-delete"
                                    ...
                                    @if($backgrounds->isEmpty())
                                        <p class="text-muted text-center">No backgrounds uploaded yet.</p>
                                    @endif
                                </div>
                            </div>
                        </div>
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', () => {
                            // Add right-click event listener to each image
                            const images = document.querySelectorAll('.image-delete');
                            images.forEach(image => {
                                image.addEventListener('contextmenu', event => {
                                    ...
                                    deleteForm.action = `/background/${imageId}`;
