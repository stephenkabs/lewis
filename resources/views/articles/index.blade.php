                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">
                                        <a class="btn btn-info btn-sm waves-effect waves-light" href="/articles"><i
                                                class="dripicons-arrow-thin-left"></i></a>
                                                @role('admin')
                                        <a class="btn btn-info btn-sm waves-effect waves-light" href="/articles/create">Add
                                            New</a>
                                            @endrole
                                    </h4>
                                    @php
                                    ...
                                    <div class="table-rep-plugin">
                                        <div class="table-responsive b-0" data-pattern="priority-columns">
                                            <table id="tech-companies-1" class="table table-striped">
                                                <thead>
                                                    <tr>
                                                        <th data-priority="1">Article Title</th>
                                                        <th data-priority="1">Article Content</th>
                                                        @role('admin')
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <button type="button"
                                                                        ...
                                                                        data-route="{{ route('articles.destroy', $item->slug) }}">
