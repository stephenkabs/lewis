                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                ...
                                <div class="mil-image-frame mil-horizontal mil-up">
                                    <img src="/article/{{ $article->image }}" alt="Publication cover" class="mil-scale" data-value-1=".90" data-value-2="1.15">
                                </div>
                                <div class="mil-info mil-up mil-mb-90">
                                    <div>Category: &nbsp;<span class="mil-dark">{{ $article->category->name }}</span></div>
                                    <div>Date: &nbsp;<span class="mil-dark">{{ \Carbon\Carbon::parse($article->created_at)->format('F j, Y') }}</span></div>
                                    <div>Author: &nbsp;<span class="mil-dark">Lewis Shikapwasha</span></div>
                                </div>

                            </div>
                            <div class="col-lg-8">

                                <p class="mil-text-xl mil-dark mil-up mil-mb-60">{{ $article->words }}</p>

                                {{-- <blockquote class="mil-up mil-mb-60">"Creativity is intelligence having fun." - Albert Einstein</blockquote> --}}

                                <h5 class="mil-up mil-mb-30">{{ $article->name }}</h5>
                                <p class="mil-up mil-mb-60">{!! $article->description !!}</p>
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div class="row align-items-center mil-mb-30">
                            ...
                            <div class="col-lg-6 mil-mb-30">
                                <div class="mil-adaptive-right mil-up">
                                    <a href="/my_publications" class="mil-link mil-dark mil-arrow-place">
                                        <span>View all</span>
                                    </a>
                                </div>
                            </div>
