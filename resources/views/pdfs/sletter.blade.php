...
<head>
    ...
    <title>Scanner Program Document</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1 style="font-size:10px"><img src="logo-dark.png" width="150px" ></h1>
        <p><strong>My Tax Your Tax Our Destiny</strong></p><hr>

        <p><strong>ZRA2024/DRU/oc/mm/MM/606-615</strong><br>June 7, 2024</p>
        <p>The Managing Director<br>ABSA Bank Zambia Plc<br>LUSAKA</p>
        ...
        <p>Please be informed that the garnish on the current ABSA payment batch should be treated as follows:</p>
...
<table>
    <thead>
        <tr>
            <th>TPIN</th>
            <th>SUPPLIER</th>
            <th>GARNISHED AMOUNT (KWACHA)</th>
            <th>GARNISHED AMOUNT (USD)</th>
        </tr>
    </thead>
    <tbody>
        <tr>
        ...
        <p>Yours faithfully,<br><strong>Monica Muchelenje</strong><br>For / DIRECTOR ENFORCEMENT</p>
