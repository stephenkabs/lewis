...
<body>
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td>{{ $garnish->document->tpin ?? 'None' }}</td>
                    <td class="text-center">{{ $garnish->document->supplier_name ?? 'Non' }}</td>
                    <td class="text-end">{{ $garnish->amount ?? 'None Garnished' }}</td>
                </tr>
            </tbody>
        </table>
        ...
        <p>Yours faithfully,<br><strong>{{ $clearance->prepared_by ?? 'None' }}</strong><br>{{ $clearance->position ?? 'None' }}</p>
