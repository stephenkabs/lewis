...
<body>
    <div class="login-container">
        ...
        <h2 style="font-size: 17px">
                ...
                <img class="logo-main" src="/settings/logo_dark/{{ $setting->image }}" alt="" width="170px">
...
<br><br>
        ...
        <a href="#"><span style="font-size: 12px; color:#1d6cb6">Forgot Password ?</span></a>
        <div class="footer">Powered by <span>AwCloud Technologies</span></div><br>
    </div>
</body>
</html>
