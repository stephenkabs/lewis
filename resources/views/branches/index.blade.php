                            ...
                            <div class="card" >
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title"><a class="btn btn-info btn-sm waves-effect waves-light"
                                        ...
                                        class="btn btn-info btn-sm waves-effect waves-light" href="/branches/create"><i class="dripicons-plus"></i></a></h4>
                                                ...
                                                <tbody>
                                                    ...
                                                    @else
                                                        @foreach ($branch as $item)
                                                            <tr>
                                                                <td><b>{{ $item->name }}</b><br>
                                                                    <span style="font-size: 12px; color:#626262">Email :
                                                                        {{ $item->email ?? 'None' }}</span>
                                                                </td>
                                                                <td><b>{{ $item->address ?? 'None' }}</b><br>
                                                                    <span style="font-size: 12px; color:#626262">Country
                                                                        :
                                                                        {{ $item->country->name ?? 'No Country' }}</span>
                                                                </td>
                                                                <td>
                                                                    <a href="{{ route('branches.edit', $item->slug) }}"
                                                                    ...
                                                                    <button type="button"
                                                                        ...
                                                                        data-route="{{ route('branches.destroy', $item->slug) }}">
