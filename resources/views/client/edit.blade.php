                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('client.update', $client->slug) }}" method="POST"
                                        ...
                                        @csrf
                                        @method('PUT') <!-- Spoof PUT method for edit -->
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="nrc" id="nrc" class="form-control"
                                                placeholder="Enter NRC" value="{{ old('nrc', $client->nrc) }}">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="phone" id="client-phone" class="form-control"
                                                placeholder="Enter Client Phone"
                                                value="{{ old('phone', $client->phone) }}">
                                        </div>

                                        <div class="mb-3">
                                            <label for="client_tpin" class="form-label">TPIN No</label>
                                            <input type="text" name="client_tpin" id="client_tpin"
                                                class="form-control" placeholder="Enter TPIN"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="employee_no" id="employee_no"
                                                class="form-control" placeholder="Enter Employee No"
                                                value="{{ old('employee_no', $client->employee_no) }}">
                                        </div>

                                        <div class="mb-3">
                                            <label for="client-address" class="form-label">Address</label>
                                            <textarea name="client_address" id="client-address" class="form-control" rows="3">{{ old('client_address', $client->client_address ?? 'No Address') }}</textarea>
                                        </div>

                                        <input type="hidden" name="status"
                                            value="{{ old('status', $client->status ?? 'Unapproved') }}">

                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-purple">Update Client</button>
