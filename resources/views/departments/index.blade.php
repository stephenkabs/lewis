                                                ...
                                                <tbody>
                                                    ...
                                                    @else
                                                        @foreach ($department as $item)
                                                            <tr>
                                                                <td style="font-size: 13px; color:rgb(102, 102, 102);">
                                                                    <b>{{ $item->name }}</b>
                                                                </td>
                                                                <td>
                                                                    <a href="{{ route('departments.edit', $item->slug) }}" class="btn btn-info waves-effect waves-light">
                                                                        <i class="dripicons-document-edit"></i>
                                                                    </a>
                                                                    <button type="button" class="btn btn-danger waves-effect waves-light" data-bs-toggle="modal"
                                                                        data-bs-target="#deleteMinistryModal" data-route="{{ route('departments.destroy', $item->slug) }}">
