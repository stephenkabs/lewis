                ...
                <div class="mil-inner-banner mil-p-0-120">
                    <div class="mil-banner-content mil-up">
                        ...
                        <div class="container">
                            ...
                            <h1 class="mil-mb-60">Pastor <span class="mil-thin">Lewis</span> <br> Ministry & Family <span class="mil-thin">Moments</span></h1>
                    ...
                    <div class="container mil-p-120-120">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <a href="{{ route('articles.public_show', $item->slug) }}" class="mil-blog-card mil-blog-card-hori mil-more mil-mb-60">
                    ...
                    <div class="container mil-p-120-120">
                        <div class="row">
                            <div class="col-lg-10">
                                ...
                                <span class="mil-suptitle mil-suptitle-right mil-suptitle-dark mil-up">If you are inspired by<br> Pastor Lewis Shikapwasha Ministry.</span>
