                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="row needs-validation" action="{{ route('details.update', $detail->slug) }}" novalidate method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="mb-3 position-relative">
                                        ...
                                        @if($detail->image)
                                            <div class="mt-2">
                                                <img src="{{ asset('logos/' . $detail->image) }}" alt="Company Logo" width="100">
                                                <p>Current Logo</p>
                                            </div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="mb-3 position-relative">
                                        ...
                                        <div>
                                            <input name="primary_color" type="color" class="form-control"  value="{{ $detail->primary_color  }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 position-relative">
                                        ...
                                        <div>
                                            <input name="secondary_color" type="color" class="form-control"  value="{{ $detail->secondary_color  }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-0">
                                        <div>
                                            ...
                                            <a href="{{ route('details.index') }}" class="btn btn-secondary waves-effect ms-1">
                                                Cancel
                                            </a>
                                        </div>
                                    </div>
