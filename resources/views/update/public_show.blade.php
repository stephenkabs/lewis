					...
					<div class="row">
						<div class="col-12 col-lg-10 offset-lg-1">
							...
							<div class="row g-3 mt-3">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="img-link-box">
                                        <h2 style="font-size: 25px" class="fw-medium">Register For {{ $update->title }} Event</h2><br><br>
                                        <form class="form-border-radius" action="{{ route('sign.store') }}" method="POST">
                                            @csrf <!-- Include CSRF protection for security -->

                                            <div class="row gx-3 gy-0 mb-3">
                                                <div class="col-12 col-md-6">
                                            ...
                                            {{-- <input type="hidden" id="user_id" name="user_id" value="{{ Auth::check() ? Auth::user()->id : '' }}"> <!-- Capture user ID if logged in -->
                                            <input type="hidden" id="slug" name="slug" value="{{ Str::slug($update->name) }}"> <!-- Automatically generate slug --> --}}

                                            <button class="button button-dark button-rounded button-lg w-100 mt-4" type="submit">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6 text-md-end">
                                    <ul class="list-inline">
                                        ...
                                        <li>
                                            <!-- X (Twitter) Share -->
                                            <a href="https://twitter.com/intent/tweet?url={{ url()->current() }}&text={{ urlencode('Check this out!') }}" target="_blank">
