                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="row needs-validation" action="{{ route('update.store') }}" novalidate method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="mb-3 position-relative">
                                        ...
                                        <div>
                                            <input name="date" data-parsley-type="number" type="date" class="form-control"
                                                placeholder="https://www.youtube.com/embed/1y_kfWUCFDQ" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 position-relative">
                                        <label class="form-label">Date</label>
                                        <div>
                                            <input name="time" data-parsley-type="number" type="time" class="form-control"
                                                placeholder="https://www.youtube.com/embed/1y_kfWUCFDQ" required />
                                        </div>
                                    </div>
                                    <div class="mb-3 position-relative">
                                    ...
                                    <div class="mb-3 position-relative">
                                        ...
                                        <div>
                                            <textarea name="about_event" class="form-control" rows="5" required></textarea>
                                        </div>
                                    </div>
                                    <div class="mb-3 position-relative">
