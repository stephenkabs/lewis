    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card" style="background-color: rgb(245, 245, 245); color: white;">
                            <div class="card-body">
                                    ...
                                    <div class="table-responsive b-0" data-pattern="priority-columns">
                                        ...
                                        <div class="d-flex justify-content-center align-items-center" style="min-height: 20vh; width: 100%;">
                                            <div class="alert alert-info text-center p-5" role="alert" style="background: linear-gradient(135deg, #e3f2fd, #90caf9); border-radius: 15px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); width: 100%;">
                                                ...
                                                <a href="{{ route('update.create') }}" class="btn btn-primary"><b>Create New Event</b></a>
                                            </div>
                                        @else
                                        <h4 class="card-title">
                                            <a class="btn btn-info waves-effect waves-light" href="#"><i class="dripicons-arrow-thin-left"></i></a>
                                            <a class="btn btn-info waves-effect waves-light" href="/update/create">Add New Event</a>
                                        </h4>
                                            <table id="tech-companies-1" class="table table-striped" style="color: white;">
                                                <thead>
                                                    <tr>
                                                        <th data-priority="1">Event</th>
                                                        <th data-priority="1">Goal</th>
                                                ...
                                                <tbody>
                                                    @foreach ($updates as $item)
                                                        <tr>
                                                            <td>
                                                            <b>{{ $item->title }}</b><br><span style="font-size: 11px; color:#6e6e6e;" >Target Type: {{ $item->target_type }}</span>
                                                            </td>
                                                            <td>
                                                                <b>{{ $item->target }}</b><br><span style="font-size: 11px; color:#6e6e6e;" >Venue: {{ $item->venue }} | Time: {{ $item->time }}</span>
                                                                </td>
                                                            <td>
                                                                <a href="{{ route('update.show', $item->slug) }}" class="btn btn-info waves-effect waves-light">View Event</a>
                                                                <a href="{{ route('update.edit', $item->slug) }}" class="btn btn-info waves-effect waves-light"><i class="dripicons-document-edit"></i></a>

                                                                <!-- Delete button to open modal -->
                                                                <button type="button" class="btn btn-danger waves-effect waves-light" data-bs-toggle="modal"
                                                                    data-bs-target="#deleteMinistryModal" data-route="{{ route('update.destroy', $item->slug) }}">
