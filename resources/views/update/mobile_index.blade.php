                            ...
                            <div class="col-md-6 col-xl-2">
                                ...
                                <div class="card">
                                    <a href="{{ route('update.show', $item->slug) }}">
                                        <img style="padding: 20px; border-radius: 30px;" class="card-img-top img-fluid" src="/updates/{{ $item->image }}" alt="Card image cap">
                                    </a>

                                        <p  style="text-align: center;padding: 20px; font-size: 12px" ><b>{{ $item->title }}</b><br><b>Date & Time:</b> {{ \Carbon\Carbon::parse($item->date)->format('F j, Y') }} | {{ $item->time }}
                                            <br><b>Venue:</b> {{ $item->venue }}
                                        <br><br>
                                        <a class="btn btn-info btn-sm waves-effect waves-light" href="/sign/create">Register</a>
                                        </p>
