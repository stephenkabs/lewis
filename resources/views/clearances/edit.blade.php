                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title"><a class="btn btn-info waves-effect waves-light"
                                            ...
                                            <form class="row needs-validation" action="{{ route('clearances.update', $clearance->slug) }}"
                                                method="POST" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')

                                                <div class="mb-3">
                                                    <label for="garnish_id" class="form-label">Select Garnished Invoice:</label>
                                                    <select name="garnish_id" id="garnish_id" class="form-control" required>
                                                        ...
                                                        @foreach ($garnishes as $garnish)
                                                            <option value="{{ $garnish->id }}"
                                                                {{ $garnish->id == $clearance->garnish_id ? 'selected' : '' }}>
                                                                {{ $garnish->document->supplier_name }} - Garnished Amount {{ $garnish->amount }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="mb-3 position-relative">
                                                    ...
                                                    <div>
                                                        <input name="bank_name" type="text" class="form-control"
                                                            ...
                                                            value="{{ old('bank_name', $clearance->bank_name) }}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 position-relative">
                                                    ...
                                                    <div>
                                                        <input name="bank_address" type="text" class="form-control"
                                                            ...
                                                            value="{{ old('bank_address', $clearance->bank_address) }}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 position-relative">
                                                    ...
                                                    <div>
                                                        <input name="director" type="text" class="form-control"
                                                            ...
                                                            value="{{ old('director', $clearance->director) }}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 position-relative">
                                                    ...
                                                    <div>
                                                        <input name="position" type="text" class="form-control"
                                                            ...
                                                            value="{{ old('position', $clearance->position) }}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-0">
                                                    <div>
                                                        ...
                                                        <a href="{{ route('clearances.index') }}" class="btn btn-secondary waves-effect ms-1">
                                                            Cancel
                                                        </a>
                                                    </div>
                                                </div>
