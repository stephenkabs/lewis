                                                ...
                                                <tbody id="table-body">
                                                    @foreach ($users as $user)
                                                        <tr>
                                                            ...
                                                            {{-- <td>
                                                                <b style="font-size: 12px">{{ formatCurrency($user->mobile->pricingPlan->price) }}</b><br>
                                                                <span style="font-size: 9px; color: rgb(112, 112, 112);">
                                                                    Package Type: {{ $user->mobile->pricingPlan->name }}
                                                                </span>
                                                            </td> --}}
                                                            <td>
                                                            @if($user->mobile->isNotEmpty())
                                                            @php
                                                                $firstMobile = $user->mobile->first();
                                                            @endphp
                                                            <b style="font-size: 12px">{{ formatCurrency($firstMobile->pricingPlan->price ?? 0) }} | {{ $firstMobile->pricingPlan->name ?? 'N/A' }}</b><br>
                                                            {{-- <span style="font-size: 9px; color: rgb(112, 112, 112);">
                                                                Package Type: {{ $firstMobile->pricingPlan->name ?? 'N/A' }} -
                                                            </span> --}}

                                                            <span style="font-size: 9px; color: {{ \Carbon\Carbon::parse($firstMobile->pricingPlan->created_at)->addMonths(1)->isToday()? 'red': 'rgb(112, 112, 112)' }};">
                                                                Due On: {{ \Carbon\Carbon::parse($firstMobile->pricingPlan->created_at)->addMonths(1)->format('F j, Y') }}
                                                            </span>
                                                        @else
                                                        <span class="badge rounded-pill bg-purple">Free Trial</span>
                                                        <br>
                                                        <span style="font-size: 11px; color:rgb(112, 112, 112);">
                                                            Due Date: {{ \Carbon\Carbon::parse($user->created_at)->addDay()->format('F j, Y') }}
                                                        </span>
