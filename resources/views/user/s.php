                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="row needs-validation" action="{{ url('user/'.$user->id) }}" novalidate method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="mb-3 position-relative">
                                        ...
                                        <div>
                                            <input name="email" data-parsley-type="number" type="text" class="form-control"
                                    ...
                                    <div class="mb-3 position-relative">
                                        ...
                                        <select type="text" name="roles[]" class="form-select"
                                            multiple  >
