...
<body>
    ...
    ============================= -->
        <section class="portfolio-layout1"
            style="background-image: linear-gradient(125deg, #093450 40%, #094c90 100%);">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="heading-layout2 mb-40">
                            <h3 class="heading__title" style="color:white">My Events</h3>
                        </div><!-- /.heading -->
                    </div><!-- /.col-lg-12 -->
                </div><!-- /.row -->
                <div class="row">
                ...
                {{-- <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12 text-center">
                        <button type="button" class="btn btn__primary btn__loadMore loadMoreportfolio">
                            <a href="/our_services"><i class="icon-arrow-right"></i><span>Explore All Services</span></a>
                        </button>
                    </div><!-- /.col-lg-12 -->
                </div><!-- /.row --> --}}
            </div><!-- /.container -->
