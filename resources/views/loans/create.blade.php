                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title"><a class="btn btn-purple waves-effect waves-light"
                                            ...
                                            <form class="row needs-validation" action="{{ route('loans.store') }}" novalidate method="POST" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="mb-3 position-relative">
                                                        ...
                                                        <div>
                                                            <input name="amount" type="number" step="0.01" class="form-control" placeholder="Enter Loan Amount" required />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3 position-relative">
                                                        ...
                                                        <div>
                                                            <input name="interest_rate" type="number" step="0.01" class="form-control" placeholder="Enter Interest Rate" required />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3 position-relative">
                                                        ...
                                                        <div>
                                                            <input name="term" type="number" class="form-control" placeholder="Enter Loan Term" required />
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="d-flex justify-content-end">
                                                        ...
                                                        <button type="reset" class="btn btn-purple waves-effect ms-2">Cancel</button>
                                                    </div>
                                                </div>
                                            </form>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form id="loan-form">
                                        ...
                                        <button type="submit" class="btn btn-purple btn-sm mt-3">Calculate Loan</button>
                                    </form>
