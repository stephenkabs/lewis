                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"><a class="btn btn-sm btn-purple waves-effect waves-light"
                                        ...
                                        class="btn btn-purple btn-sm waves-effect waves-light"
                                        href="/loans/create">Add New Loan</a></h4>
                                            ...
                                            <tbody>
                                                ...
                                                @else
                                                    @foreach ($loans as $item)
                                                        <tr>
                                                            <td><b>{{ $item->client->client_name }}</b><br>
                                                                <span
                                                            ...
                                                            <td>
                                                                <a class="btn btn-purple waves-effect waves-light show-loan-details"
                                                                    data-id="{{ $item->id }}"
                                                            ...
                                                            <button type="button"
                                                                class="btn {{ $btnClass }} waves-effect waves-light update-loan-status-btn"
                                                                data-id="{{ $item->id }}"
