                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title"><a class="btn btn-danger waves-effect waves-light"
                                            ...
                                            <form class="row needs-validation" action="{{ route('loans.update', $loan->id) }}" novalidate method="POST" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="client_id" class="form-select" required>
                                                            ...
                                                            @foreach ($clients as $item)
                                                                <option value="{{ $item->id }}" {{ $loan->client_id == $item->id ? 'selected' : '' }}>{{ $item->client_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="mb-3 position-relative">
                                                        ...
                                                        <div>
                                                            <input name="amount" type="number" step="0.01" class="form-control" placeholder="Enter Loan Amount" value="{{ $loan->amount }}" required />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3 position-relative">
                                                        ...
                                                        <div>
                                                            <input name="interest_rate" type="number" step="0.01" class="form-control" placeholder="Enter Interest Rate" value="{{ $loan->interest_rate }}" required />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3 position-relative">
                                                        ...
                                                        <div>
                                                            <input name="term" type="number" class="form-control" placeholder="Enter Loan Term" value="{{ $loan->term }}" required />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3 position-relative">
                                                        ...
                                                        <div>
                                                            <input name="start_date" type="date" class="form-control" value="{{ $loan->start_date }}" required />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3 position-relative">
                                                        ...
                                                        <div>
                                                            <input name="due_date" type="date" class="form-control" value="{{ $loan->due_date }}" required />
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="d-flex justify-content-end">
                                                        ...
                                                        <a href="/loans" class="btn btn-secondary waves-effect ms-2">Cancel</a>
                                                    </div>
                                                </div>
                                            </form>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form id="loan-form">
                                        ...
                                        <button type="submit" class="btn btn-danger btn-sm mt-3">Calculate Loan</button>
                                    </form>
