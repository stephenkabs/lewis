                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><a class="btn btn-danger waves-effect waves-light"
                                        ...
                                        <form class="row needs-validation" action="{{ route('loans.store') }}" novalidate
                                      ...
                                      <div class="col-md-6">
                                          ...
                                          <!-- Show available investment amount -->
                                          <div class="mb-3 position-relative">
                                              <label class="form-label">Available Capital</label>
                                              <input type="text" class="form-control"
                                                     value="{{ number_format($investment->invested_amount ?? 0, 2) }} ZMW" readonly />
                                          </div> --}}
                                      ...
                                      <div class="col-12">
                                          <div class="d-flex justify-content-end">
                                              ...
                                              <button type="reset"
                                                      class="btn btn-secondary waves-effect ms-2">Cancel</button>
                                          </div>
                                      </div>
                                  </form>
