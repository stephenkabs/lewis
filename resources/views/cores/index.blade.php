                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">
                                        <a class="btn btn-success btn-sm waves-effect waves-light" href="/core"><i
                                                class="dripicons-arrow-thin-left"></i></a>
                                                @role('admin')
                                        <a class="btn btn-success btn-sm waves-effect waves-light" href="/cores/create">Add
                                            New</a>
                                            @endrole
                                    </h4>
                                    @php
                                    ...
                                    <div class="table-rep-plugin">
                                        <div class="table-responsive b-0" data-pattern="priority-columns">
                                            <table id="tech-companies-1" class="table table-striped">
                                                <thead>
                                                    <tr>
                                                        <th data-priority="1">Core Title</th>
                                                        <th data-priority="1">Core Content</th>
                                                        @role('admin')
                                                            ...
                                                            <tr>
                                                                ...
                                                                @if (strlen($item->words) > 10)
                                                                    <td>
                                                                        ...
                                                                        {{-- <a href="{{ route('cores.show', $item->slug) }}"
                                                                ...
                                                                @endif
                                                                    ...
                                                                    @role('admin')
                                                                <td>
                                                                    <a href="{{ route('cores.edit', $item->slug) }}"
                                                                    ...
                                                                    <button type="button"
                                                                        ...
                                                                        data-route="{{ route('cores.destroy', $item->slug) }}">
