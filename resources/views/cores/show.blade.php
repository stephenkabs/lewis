                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title"><a class="btn btn-info waves-effect waves-light"
                                            href="/feature"><i class="dripicons-arrow-thin-left"></i></a>
                                        <a class="btn btn-info waves-effect waves-light"
                                            href="{{ route('feature.edit', $feature->slug) }}"><i
                                                class="dripicons-document-edit"></i></a><br><br>


                                        <h4 class="card-title"> {{ $feature->name }}'s feature of the Day <br>
                                            <span style="font-size: 13px; color:rgb(158, 158, 158);"> Posted Date:
                                                {{ $feature->created_at }} |
                                            </span></h4>

                                        <p> {{ $feature->words }}<br><br>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    {{-- <embed src="/feature/{{ $feature->image }}#toolbar=0"  width="53%"/> --}}
                                    <img src="/feature/{{ $feature->image }}" alt=""
