...
<body data-sidebar="dark" style="background: linear-gradient(135deg, #eaeff9, #ffffff);">
                    ...
                    <div class="row">
                        ...
                        {{-- <div class="col-lg-12">
                            <div style="position: relative; width: fit-content;">
                                <!-- The card with gradient background -->
                                <div
                                    style="position: relative; top: 70px; left: 300px; display: flex; align-items: center; background: linear-gradient(135deg, #1e3c72, #2a5298); padding: 20px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                                    <div
                                ...
                                <div class="col-lg-4 col-md-6 mb-4">
                                    <a href="/role" style="text-decoration: none;">
                                        <div class="d-flex align-items-center p-3"
                                            ...
                                            <div>
                                                <h6 class="mb-0">Home Manager</h6>
                                                <p style="font-size: 10px" class="mb-0 text-muted">Home Sections Management</p>
                                            </div>
                            ...
                            <a href="/about_us" style="text-decoration: none;">
                                <div class="d-flex align-items-center p-3"
                                    ...
                                    <div>
                                        ...
                                        <p style="font-size: 10px" class="mb-0 text-muted">Manage About Page and Sections</p>
                                    </div>
                            ...
                            <a href="/terminal/form" style="text-decoration: none;" target="blank" >
                                <div class="d-flex align-items-center p-3"
                                    ...
                                    <div>
                                        ...
                                        <p style="font-size: 10px" class="mb-0 text-muted">Manage Operations and Sub Sections</p>
                                    </div>
                                               ...
                                               <!-- Add more items as needed -->
                        <div class="col-lg-4 col-md-6 mb-4">
                            <a href="/services" style="text-decoration: none;" target="blank" >
                                <div class="d-flex align-items-center p-3"
                                    style="background-color: white; border: 1px solid #ccc; border-radius: 10px;">
                                    <div class="icon-container me-3"
                                        style="width: 50px; height: 50px; display: flex; justify-content: center; align-items: center; background-color: #f5f5f5; border-radius: 5px;">
                                    ...
                                    <div>
                                        ...
                                        <p style="font-size: 10px" class="mb-0 text-muted">Manage Services Pages and Sub Sections</p>
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <a href="/terminal/form" style="text-decoration: none;" target="blank" >
                                <div class="d-flex align-items-center p-3"
                                    ...
                                    <div class="icon-container me-3"
                                        style="width: 50px; height: 50px; display: flex; justify-content: center; align-items: center; background-color: #f5f5f5; border-radius: 5px;">
                                        <i class="ion ion-ios-speedometer" style="font-size: 24px; color: #555;"></i>
                                    </div>
                                    <div>
                                        <h6 class="mb-0">CSR Pages</h6>
                                        <p style="font-size: 10px" class="mb-0 text-muted">Manage CSR and Sub Sections and Pages</p>
                                    </div>
                                               ...
                                               <!-- Add more items as needed -->
                        <div class="col-lg-4 col-md-6 mb-4">
                            <a href="/articles" style="text-decoration: none;" target="blank" >
                                <div class="d-flex align-items-center p-3"
                                    style="background-color: white; border: 1px solid #ccc; border-radius: 10px;">
                                    <div class="icon-container me-3"
                                        style="width: 50px; height: 50px; display: flex; justify-content: center; align-items: center; background-color: #f5f5f5; border-radius: 5px;">
                                        <i class="ion ion-md-chatboxes" style="font-size: 24px; color: #555;"></i>
                                    </div>
                                    <div>
                                        <h6 class="mb-0">News</h6>
                                        <p style="font-size: 10px" class="mb-0 text-muted">Manage News Posts and Its Categories</p>
                                    </div>
                            ...
                            <a href="/features" style="text-decoration: none;">
                                <div class="d-flex align-items-center p-3"
                                    ...
                                    <div>
                                        ...
                                        <p style="font-size: 10px" class="mb-0 text-muted">Manage Your Features Preferences</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <!-- Add more items as needed -->
                        <div class="col-lg-4 col-md-6 mb-4">
                            <a href="/cores" style="text-decoration: none;">
                                <div class="d-flex align-items-center p-3"
                                    style="background-color: white; border: 1px solid #ccc; border-radius: 10px;">
                                    <div class="icon-container me-3"
                                        style="width: 50px; height: 50px; display: flex; justify-content: center; align-items: center; background-color: #f5f5f5; border-radius: 5px;">
                                    ...
                                    <div>
                                        <h6 class="mb-0">About Home & Core Value</h6>
                                        <p style="font-size: 10px" class="mb-0 text-muted">Manage About Home Section</p>
                                    </div>
                        ...
                        <!-- Add more items as needed -->
                        <div class="col-lg-4 col-md-6 mb-4">
                            <a href="/menus" style="text-decoration: none;">
                                <div class="d-flex align-items-center p-3"
                                    style="background-color: white; border: 1px solid #ccc; border-radius: 10px;">
                                    <div class="icon-container me-3"
                                        style="width: 50px; height: 50px; display: flex; justify-content: center; align-items: center; background-color: #f5f5f5; border-radius: 5px;">
                                    ...
                                    <div>
                                        ...
                                        <p style="font-size: 10px" class="mb-0 text-muted">Manage Your Links & Menu Preferences</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <a href="/broadcast" style="text-decoration: none;">
                            <div class="d-flex align-items-center p-3"
                                ...
                                <div>
                                    ...
                                    <p style="font-size: 10px" class="mb-0 text-muted">Manage Mopani YouTube Channel</p>
                                </div>
