                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"><a class="btn btn-purple waves-effect waves-light"
                                        ...
                                        <form class="row needs-validation" action="{{ route('repayments.store') }}" novalidate method="POST">
                                            @csrf
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-3 position-relative">
                                                    ...
                                                    <div>
                                                        <input name="amount_paid" type="number" step="0.01" class="form-control" placeholder="Enter Amount Paid" required />
                                                    </div>
                                                </div>
