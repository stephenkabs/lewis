            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-md-6 col-xl-3">
                        <div class="card text-center">
                            <div class="mb-2 card-body text-muted">
                                <h3 class="text-danger mt-2" style="font-size: 16px">15,852</h3> Invested Amount
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-3">
                        <div class="card text-center">
                            <div class="mb-2 card-body text-muted">
                                <h3 class="text-danger mt-2" style="font-size: 16px">9,514</h3> Profit Made
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-3">
                        <div class="card text-center">
                            <div class="mb-2 card-body text-muted">
                                <h3 class="text-danger mt-2" style="font-size: 16px">{{ formatCurrency($totalPaidToday) }}</h3>
                                Amount Paid Today
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card text-center">
                            <div class="mb-2 card-body text-muted">
                                <h3 class="text-danger mt-2" style="font-size: 16px">{{ $usersPaidToday }}</h3>
                                Clients Paid Today
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><a class="btn btn-sm btn-danger waves-effect waves-light"
                                    ...
                                    <a class="btn btn-danger btn-sm waves-effect waves-light" href="/repayments/create">Add
                                        New Payment</a></h4>
