...
<head>
    ...
    <!-- FontAwesome JS-->
    <script defer src="/doc_assets/fontawesome/js/all.min.js"></script>

    <!-- Theme CSS -->
    <link id="theme-style" rel="stylesheet" href="/doc_assets/css/devdesk.css">
...
<body>
				...
				<nav class="navbar navbar-expand-lg" >
					<div class="site-logo me-3">
						<a class="navbar-brand" href="index.html">
							<img class="logo-icon" src="/doc_assets/images/site-logo.svg" alt="logo">
						</a>
					</div><!--//site-logo-->
		           ...
		           <div class="side-bar">
			            ...
			            <nav class="side-bar-nav">
				            <ul class="sidebar-nav-items list-unstyled flex-column">
                                @foreach ($similarPackages as $item)
					           <li class="nav-item"><a href="{{ route('doc.public_show', $item->slug) }}">{{ $item->name }}</a></li>
                               @endforeach
	...
	<footer class="footer py-3">
		<div class="container text-center">
            ...
            <small class="copyright"><a style="font-size: 10px; display: inline-block;">&copy;<script>document.write(new Date().getFullYear())</script> {{ $setting->copyright }}</a></small>
            @endforeach
		</div><!--//container-->
	</footer><!--//footer-->

	<!-- Javascript -->
    <script src="/doc_assets/plugins/popper.min.js"></script>
    <script src="/doc_assets/plugins/bootstrap/js/bootstrap.min.js"></script>

    <!-- Page Specific JS -->
    <script src="/doc_assets/plugins/stickyfill/dist/stickyfill.min.js"></script>
    <script src="/doc_assets/js/sticky-custom.js"></script>
