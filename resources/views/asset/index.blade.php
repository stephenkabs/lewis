                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title"><a class="btn btn-info btn-sm waves-effect waves-light"
                                            ...
                                            class="btn btn-info btn-sm waves-effect waves-light" href="/asset/create"><i class="dripicons-plus"></i>
                                            </a></h4>
                                    ...
                                    <div class="table-rep-plugin">
                                        <div class="table-responsive b-0" data-pattern="priority-columns">
                                            <table id="tech-companies-1" class="table table-striped">
                                                <thead>
                                                    <tr>
                                                        <th data-priority="1">Asset Name</th>
                                                        <th data-priority="3">Asset Amount</th>
                                                    ...
                                                    @else
                                                        @foreach ($asset as $items)
                                                            <tr>
                                                                <td>{{ $items->name }}
                                                                    <br><span
                                                                        style="font-size: 11px; color:rgb(112, 112, 112);">Asset
                                                                        Name</span>
                                                                </td>


                                                                </td>
                                                                <td>{{ formatCurrency($items->amount) }}

                                                                    <br>
                                                                    <span
                                                                        style="font-size: 11px;
                                                                    color: {{ \Carbon\Carbon::parse($items->delivery_date)->isToday() ? 'green' : 'rgb(112, 112, 112)' }};">
                                                                        Delivered:
                                                                        {{ \Carbon\Carbon::parse($items->delivery_date)->format('F j, Y') }}
                                                                    </span>
                                                                </td>

                                                                <td>
                                                                    <b><a href="/asset_files/{{ $items->image }}"
                                                                            download>
                                                                            {{ $items->attachment_name ?? 'No File Name' }}
                                                                        </a></b>
                                                                    <br><span
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a class="btn btn-info waves-effect waves-light"
                                                                        href="{{ route('asset.show', $items->slug) }}"><i
                                                                            class="dripicons-preview"></i></a>
                                                                    <a class="btn btn-info waves-effect waves-light"
                                                                        id="sa-warning"
                                                                        href="{{ route('asset.edit', $items->slug) }}"><i
                                                                            class="dripicons-document-edit"></i></a>
                                                                    <button type="button"
                                                                        class="btn btn-danger waves-effect waves-light"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#deleteMinistryModal"
                                                                        data-route="{{ route('asset.destroy', $items->slug) }}">
