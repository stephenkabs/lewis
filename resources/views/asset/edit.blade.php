                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="row needs-validation"
                                        action="{{ route('asset.update', $asset->slug) }}" novalidate method="POST"
                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <input type="text" name="name" class="form-control"
                                                id="validationCustom01" value="{{ $asset->name }}" required />
                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <input type="number" name="amount" class="form-control"
                                                id="validationCustom01" value="{{ $asset->amount }}" required />
                                            <div class="valid-tooltip">
                                                Looks good!
                                            </div>
                                        </div>
                                        ...
                                        <input type="text" name="supplier_name" class="form-control" id="validationCustom01"
                                            value="{{ $asset->supplier_name }}" required />
                                        <div class="valid-tooltip">
                                            Looks good!
                                        </div>
                                    </div> --}}
                                        ...
                                        <input type="text" name="supplier_contact" class="form-control" id="validationCustom01"
                                            value="{{ $asset->supplier_contact }}" required />
                                        <div class="valid-tooltip">
                                            Looks good!
                                        </div>
                                    </div> --}}
                                        <div class="mb-3 position-relative">
                                            ...
                                            <div>
                                                <input name="delivery_date" data-parsley-type="number" type="date"
                                                    class="form-control" value="{{ $asset->delivery_date }}" required />
                                            </div>
                                        </div>
                                        {{-- <div class="mb-3 position-relative">
                                        ...
                                        <div>
                                            <input name="warrant_start_date" data-parsley-type="number" type="date" class="form-control"
                                                value="{{ $asset->warrant_start_date }}" required />
                                        </div>
                                    </div> --}}
                                        {{-- <div class="mb-3 position-relative">
                                        ...
                                        <div>
                                            <input name="warrant_duration" data-parsley-type="number" type="text" class="form-control"
                                                value="{{ $asset->warrant_duration }}" required />
                                        </div>
                                    </div> --}}
                                        {{-- <div class="mb-3 position-relative">
                                            ...
                                            <div>
                                                <input name="image" data-parsley-type="number" type="file"
                                                    class="form-control" value="Enter Date" />
                                            </div>
                                        </div> --}}
                                        {{-- <div class="mb-3 position-relative">
                                            ...
                                            <div>
                                                <input name="attachment_name" data-parsley-type="number" type="text"
                                                    class="form-control" value="{{ $asset->attachment_name }}"
                                                    required />
                                            </div>
                                        </div> --}}
                                        <div class="mb-3 position-relative">
                                            ...
                                            <div>
                                                <textarea name="asset_description" class="form-control" rows="5" required>{{ $asset->asset_description }}</textarea>
                                            </div>
                                        </div>
                                        <div class="mb-0">
                                            <div>
