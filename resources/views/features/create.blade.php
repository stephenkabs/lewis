...
<form class="needs-validation" action="{{ route('features.store') }}" novalidate method="POST" enctype="multipart/form-data">
    @csrf
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Use Font Awesome Link e.g., <a href="https://fontawesome.com/v4/icons/"><code>https://fontawesome.com/v4/icons/</code></a></small>
                    </div>
