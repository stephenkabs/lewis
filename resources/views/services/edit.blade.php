...
<head>
    <meta charset="utf-8" />
    <title>Services | {{ $service->slug }}</title>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="needs-validation" action="{{ route('services.update', $service->slug) }}"
                        ...
                        <div class="col-lg-8">
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <textarea id="elm1" name="description">{{ old('description', $service->description) }}</textarea>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="status" class="form-select" required>
                                            ...
                                            <option value="Unpublish" {{ old('status', $service->status) == 'Unpublish' ? 'selected' : '' }}>Unpublish</option>
                                            <option value="Publish" {{ old('status', $service->status) == 'Publish' ? 'selected' : '' }}>Publish</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="words" class="form-control" rows="5" required>{{ old('words', $service->words) }}</textarea>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="mt-2">
                                            @if($service->image)
                                                <img id="image-preview" src="/service/{{ $service->image }}" alt="Image Preview"
