                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">
                                        <a class="btn btn-info btn-sm waves-effect waves-light" href="/studio"><i
                                                class="dripicons-arrow-thin-left"></i></a>
                                                @role('admin')
                                        <a class="btn btn-info btn-sm waves-effect waves-light" href="/services/create">Add
                                            New</a>
                                            @endrole
                                    </h4>
                                    @php
                                    ...
                                    <div class="table-rep-plugin">
                                        <div class="table-responsive b-0" data-pattern="priority-columns">
                                            <table id="tech-companies-1" class="table table-striped">
                                                <thead>
                                                    <tr>
                                                        <th data-priority="1">Service Title</th>
                                                        <th data-priority="1">Service Content</th>
                                                        @role('admin')
                                                        ...
                                                        @foreach ($service as $item)
                                                            <tr>
                                                                ...
                                                                @endif
                                                                    ...
                                                                    @role('admin')
                                                                <td>
                                                                    <a href="{{ route('services.edit', $item->slug) }}"
                                                                    ...
                                                                    <button type="button"
                                                                        ...
                                                                        data-route="{{ route('services.destroy', $item->slug) }}">
