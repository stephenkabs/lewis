                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title"><a class="btn btn-info waves-effect waves-light"
                                            href="/services"><i class="dripicons-arrow-thin-left"></i></a>
                                        <a class="btn btn-info waves-effect waves-light"
                                            href="{{ route('services.edit', $service->slug) }}"><i
                                                class="dripicons-document-edit"></i></a><br><br>


                                        <h4 class="card-title"> {{ $service->name }}'s service of the Day <br>
                                            <span style="font-size: 13px; color:rgb(158, 158, 158);"> Posted Date:
                                                {{ $service->created_at }} |
                                            </span></h4>

                                        <p> {{ $service->words }}<br><br>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    {{-- <embed src="/service/{{ $service->image }}#toolbar=0"  width="53%"/> --}}
