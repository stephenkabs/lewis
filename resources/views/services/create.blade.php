        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    <form class="needs-validation" action="{{ route('services.store') }}" novalidate method="POST"
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <select name="category_id" class="form-select" id="validationCustom01"
                                                required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input name="image" id="image-input" type="file" class="form-control"
                                                accept="image/*" />
                                            <div class="mt-2">
