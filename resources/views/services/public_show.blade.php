                        ...
                        <div class="row justify-content-between align-items-center">
                            <div class="col-lg-6 col-xl-5">
                                    ...
                                    <div class="mil-mb-90">
                                        ...
                                        @php
                                            $titleWords = explode(' ', $service->name);
                                        ...
                                        <p class="mil-up mil-mb-30">{{ $service->words }}</p>
                                        ...
                                        <div class="mil-about-quote">
                                            ...
                                            <h6 class="mil-quote mil-up">Author: <span
                                                    class="mil-thin">Pastor Lewis Shikapwasha</span><br> Contact Us <span
                                                    class="mil-thin">For Ordering</span></h6>
                                        </div><br>
                                        <div class="mil-up"><a href="/contact-us"
                                            class="mil-button mil-arrow-place mil-mb-60"><span>Contact Me</span></a>
                                    </div>
                                    </div>
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="mil-about-photo mil-mb-90">
                                    ...
                                    <div class="mil-up mil-img-frame" style="padding-bottom: 160%;">
                                        <img src="/service/{{ $service->image }}" alt="img" class="mil-scale"
