        ...
        <table class="table table-striped">
            ...
            <tbody id="table-body">
                ...
                @foreach ($users as $user)
                    @if($user->donation && $user->donation->isNotEmpty() && \Carbon\Carbon::parse($user->donation->first()->created_at)->addMonths(1)->isToday())
                        ...
                        <tr>
                            ...
                            <td>
                                <b style="font-size: 12px">
                                    {{ \Carbon\Carbon::parse($user->donation->first()->created_at)->format('F j, Y') }}
                                </b><br>
                                <span style="font-size: 9px; color: red;">
                                    Due On:
                                    {{ \Carbon\Carbon::parse($user->donation->first()->created_at)->addMonths(1)->format('F j, Y') }}
                                </span>
                            </td>
                            <td>
                                <!-- Edit Button -->
