            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div id="apps-container" class="row">
                        ...
                        <div class="col-lg-2 m-1 app-card" data-name="{{ strtolower($item->stream_name) }}">
                            <div class="card hover-expand" style="background-color: transparent; border-radius: 7px; box-shadow: none;">
                                <a href="{{ $item->stream_link }}" target="_blank">
                                    <img style="width: 100%; border-radius: 7px;" src="/stream_icons/{{ $item->file }}" class="img-fluid" alt="Responsive image">
                                </a>
