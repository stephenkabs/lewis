...
@include('includes.sidebar')
    ...
    <div class="main-content">
        ...
        <div class="col-lg-12">
            <div  style="background: radial-gradient(circle, rgb(13, 64, 84) 30%, rgb(6, 24, 57) 100%); border-radius: 7px;">
                <div style="position: relative; width: fit-content;">
                    <!-- The image -->
                    @foreach ($background as $item)
                    @if ($item->type == 'live_channels_image')
                    <img style="width: 120%; border-radius: 7px;" src="/background_images/{{ $item->image }}" class="img-fluid" alt="Responsive image">
                    @endif
                    @endforeach

                    <!-- The text -->
                    {{-- <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); color: white; font-size: 20px; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8); font-weight: bold; text-align: center;">
                        Run your Business Smart with AwCloud Smart Business Manager<br>Your Business in Safe Hands. #Making your Business Smart..
                    </div> --}}
                </div>
                    ...
                    <div class="d-flex justify-content-left flex-wrap">
                        ...
                        <div class="col-lg-2 m-2">
                            <div class="card hover-expand" style="background-color: transparent; border-radius: 7px; box-shadow: none;">
                                ...
                                <a href="{{ route('broadcast.show', $item->slug) }}" >
                                    <img style="width: 100%; border-radius: 7px;" src="/icons/images/{{ $item->image }}" class="img-fluid" alt="Responsive image">
                                </a>
                            ...
                            <script>
                                ...
                                function applyWordLimit() {
                                    // Select all paragraphs with the class "truncate-text"
                                    const paragraphs = document.querySelectorAll('.truncate-text');

                                    // Loop through each paragraph and apply the word limit
                                    paragraphs.forEach(paragraph => {
                                        ...
                                        if (words.length > WORD_LIMIT) {
                                            ...
                                            paragraph.innerText = words.slice(0, WORD_LIMIT).join(' ') + '...';
                                        }
                                    });
                                }
