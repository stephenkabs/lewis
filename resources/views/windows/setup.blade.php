...
<script>
    ...
    <div class="sidebar"><br><br>
      <ul style="font-size: 12px;">
        ...
        <li data-target="finish">Complete Setup</li>
    ...
    <div id="business-details" class="content-container active">
        ...
        <form id="business-form" action="{{ route('details.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label style="font-size: 10px">Company Primary Color</label>
                <input type="color" id="business-location" name="primary_color" placeholder="Enter your business Website">
            </div>
            <div class="form-group">
                <label style="font-size: 10px">Company Secondary Color</label>
                <input type="color" id="business-location" name="secondary_color" placeholder="Enter your business Website">
            </div>
            <div class="form-group">
                <label style="font-size: 10px">Business Logo</label>
...
@endif
  ...
  <style>
    ...
    <div id="finish" class="content-container">
      <h2>Finish</h2>
      <p style="color: #2e7d32">Congratulations! You have successfully set up your VM. Please continue by clicking the link below.</p>
      <a href="/dashboard" class="btn btn-primary">Access your VM</a><br><br>
      @foreach ($displaySettings as $setting )
      <p style="color: #555555; font-size: 12px;"><b>About VM</b><br><br>{{ $setting->about }}</p>
      @endforeach
    </div>
  </div>
