        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div style="display: flex; justify-content: left; align-items: center; min-height: 80vh;">
                        <div style="position: relative; width: 90%; max-width: 1200px; border-radius: 15px; overflow: hidden; box-shadow: 0 8px 20px rgba(0, 0, 0, 0.3); background: #000;">
                            <!-- YouTube Player -->
                            <div id="player" style="border-radius: 15px;"></div>

                            <!-- Custom Controls -->
                            <div style="display: flex; justify-content: center; align-items: center; gap: 15px; padding: 15px; background-color: #222; border-radius: 0 0 15px 15px;">
                                <button href="/dashboard" style="background-color: #444; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer; font-size: 16px;">
                                    <i class="dripicons-power"></i>
                                </button>
                                <button id="fullscreenBtn" style="background-color: #444; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer; font-size: 16px;">
                                    <i class="ion ion-md-expand"></i>
                                </button>
                                <button id="playPauseBtn" style="background-color: #444; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer; font-size: 16px;">
                                    ▶
                                </button>
                                <button  style="background-color: #444; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer; font-size: 16px;">
                                    Hisense
                                </button>
                                      <i style="color: white; font-size:14px" class="ion ion-md-volume-high"></i><input id="volumeControl" type="range" min="0" max="100" value="50" style="cursor: pointer; width: 200px;">
                    ...
                    <script>
                        let player; // Global variable for YouTube player
                        ...
                        function onYouTubeIframeAPIReady() {
                            player = new YT.Player('player', {
                                height: '600',
                                width: '100%',
                                videoId: 'uC5lqcyBybE', // Replace with your video ID
                                playerVars: {
                        ...
                        function onPlayerReady(event) {
                            ...
                            // Fullscreen button functionality for all fullscreen buttons
