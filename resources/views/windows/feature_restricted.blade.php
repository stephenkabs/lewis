...
<body class="font-body">
    ...
    <div class="card">
        ...
        <h2>Access denied</h2>
        <p>Feature not included in your plan. If the issue persists, please reach out to the administrator for assistance.<br>
            @foreach ($displaySettings as $setting )
            <span style="font-size: 12px">{{ $setting->email  }} | {{ $setting->phone  }} </span><br>
            @endforeach
        </p>
        <a href="/dashboard" class="back-button">Desktop</a>
    </div>
</body>
</html>
