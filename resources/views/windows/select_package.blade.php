            ...
            <div class="2xl:w-1/4 lg:w-1/3 md:w-1/2 w-full">
                <div class="bg-black/60 backdrop-blur-3xl overflow-hidden sm:rounded-md rounded-none mx-4">
                    <div class="p-6">
                        ...
                        <p class="text-gray-200 text-center"><span style="font-size: 20px"><b>Select Package & Subscribe</b></span></a></p>



    <div class="mb-6 text-center">
        <a class="w-full inline-flex items-center justify-center px-6 py-2 backdrop-blur-2xl bg-white/70 text-black rounded-lg transition-all duration-500 group hover:bg-blue-600/60 hover:text-white mt-5" href="/checkout">Continue</a>
    </div>




                        <p class="text-gray-200 text-center">Try 5 Days free trial:  <a href="/dashboard" class="text-blue-600 ms-1"><b>Demo</b></a></p>
                    </div>
                </div>
            </div>
        </div>
