                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="row needs-validation" action="{{ route('user.update', $user->slug) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="mb-3 position-relative">
                                        ...
                                        <input name="email" type="email" class="form-control" value="{{ $user->email }}" readonly required />
                                    </div>
