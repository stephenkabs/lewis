                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title"><a class="btn btn-info waves-effect waves-light" href="/general_settings"><i class="dripicons-arrow-thin-left"></i></a> <a class="btn btn-info waves-effect waves-light" href="/user/create">Add New</a></h4>
                                                ...
                                                <tr>
                                                   ...
                                                   <td> @if (!empty($user->getRoleNames()))
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="btn btn-info waves-effect waves-light" href="{{ route('user.show',$user->slug) }}"><i class="dripicons-preview"></i></a>
                                                        ...
                                                        <a class="btn btn-info waves-effect waves-light" id="sa-warning" href="{{ route('user.edit',$user->slug) }}"><i class="dripicons-document-edit"></i></a>
                                                                                      ...
                                                                                      data-bs-target="#deleteMinistryModal" data-route="{{ route('user.destroy', $user->slug) }}">
