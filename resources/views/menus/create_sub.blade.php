                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="row needs-validation" action="{{ route('menu.store') }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="name" class="form-select">
                                                <option value="" disabled selected>Select Menu Parent</option>
                                                @foreach ($menu as $item)
                                                <option value="contact">{{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <div>
                                                <input name="link" data-parsley-type="number" type="text"
                                                    class="form-control" placeholder="Enter Menu Link" required />
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="type" class="form-select">
                                                ...
                                                <option value="contact">Contact Menu</option>
                                                <option value="resources">Resources Menu</option>
                                                <option value="solution">Solutions Menu</option>
                                                <option value="product">Product Menu</option>
                                                <option value="company">Company Menu</option>
