                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title"><a class="btn btn-sm btn-success waves-effect waves-light"
                                            href="/menu"><i class="dripicons-arrow-thin-left"></i></a>
                                            <a class="btn btn-sm btn-success waves-effect waves-light" href="/menus/create"><i class="dripicons-plus"></i></a>
...
<table class="table table-bordered">
    ...
    <tbody>
        @foreach ($menus as $menu)
            @include('menus.partials.menu-row', ['menu' => $menu, 'prefix' => ''])
        @endforeach
    </tbody>
</table>
