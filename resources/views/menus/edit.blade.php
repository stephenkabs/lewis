...
<form action="{{ route('menus.update', $menu->id) }}" method="POST">
    ...
    <!-- Title -->
    <input type="text" name="title" value="{{ old('title', $menu->title) }}" placeholder="Menu Title" required>

    <!-- URL -->
    <input type="text" name="url" value="{{ old('url', $menu->url) }}" placeholder="Menu Link">
    ...
    <select name="parent_id">
        ...
        @foreach ($menus as $m)
            @include('menus.partials.menu-option-edit', [
                ...
                'prefix' => '',
                'currentId' => $menu->id,
                'selectedId' => old('parent_id', $menu->parent_id)
            ])
        @endforeach
    </select>

    <!-- Order -->
    <input type="number" name="order" value="{{ old('order', $menu->order) }}" placeholder="Display Order">
    ...
    <button type="submit">Update</button>
                                            ...
                                            <script>
                                                // Event Listener for Menu Type Dropdown
                                                document.getElementById('menuType').addEventListener('change', function () {
                                                    ...
                                                    if (menuType === 'sub_menu') {
                                                        // Hide Menu Name and show Sub Name field
                                                        menuNameField.style.display = 'none';
                                                        subMenuFields.style.display = 'block';
                                                    } else {
                                                        // Show Menu Name and hide Sub Name field
                                                        menuNameField.style.display = 'block';
