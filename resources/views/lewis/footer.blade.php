                        ...
                        <div class="container mil-p-120-60">
                            <div class="row justify-content-between">
                                <div class="col-md-4 col-lg-4 mil-mb-60">
                                    ...
                                    <div class="mil-muted mil-logo mil-up mil-mb-30">Pastor Lewis.</div>
                                        ...
                                        <div class="col-md-6 col-lg-7">
                                            ...
                                            <nav class="mil-footer-menu mil-mb-60">
                                                <ul>
                                                    ...
                                                    <li class="mil-up">
                                                        <a href="/my_publications">Family & Ministry</a>
                                                    </li>
                                                    <li class="mil-up">
                                                        <a href="/book_store">Book Store</a>
                                                    </li>
                                                    <li class="mil-up">
                                                        <a href="/contact-us">Contact</a>
                                                    </li>
                                                    {{-- <li class="mil-up">
                                                        <a href="/my_publications">Publications</a>
                                                    </li> --}}
                                                </ul>
                                            </nav>
                            ...
                            <div class="row justify-content-between flex-sm-row-reverse">
                                <div class="col-md-7 col-lg-6">
                                    ...
                                    <div class="row justify-content-between">
                                        ...
                                        <div class="col-md-6 col-lg-5 mil-mb-60">
                                            ...
                                            <h6 class="mil-muted mil-up mil-mb-30">Australia</h6>

                                            <p class="mil-light-soft mil-up">Perth
                                                <span class="mil-no-wrap">+61 405 071 440</span>
                                            </p>
                                ...
                                <div class="col-md-4 col-lg-6 mil-mb-60">
                                    ...
                                    <div class="mil-vert-between">
                                        ...
                                        <p class="mil-light-soft mil-up">© Copyright 2025 - AwCloud Technologies. All Rights Reserved.
                                        </p>
                                    </div>
