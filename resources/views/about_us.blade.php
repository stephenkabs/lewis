...
<!--                                     <div class="col-12 text-center">
                                    ...
                                    <img src="/site_asset/images/misc/8.webp" class="img-fluid rounded-10 mt-4 wow zoomIn" alt="">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="p-5 bg-color text-white rounded-20px">
                                ...
                                <div class="row g-4">
                                    <div class="col-lg-3">
                                        <img src="/site_asset/images/team/1.webp" class="img-fluid rounded-10px" alt="">
                                    ...
                                    <div class="col-lg-3">
                                        <img src="/site_asset/images/team/2.webp" class="img-fluid rounded-10px" alt="">
                                        <div class="p-3 text-center
                                        ">
                                            <h4 class="mb-0">Jeffery Mussman</h4>
                                            <p class="mb-2">Founder &amp;  CEO</p>
                                    ...
                                    <div class="col-lg-3">
                                        <img src="/site_asset/images/team/3.webp" class="img-fluid rounded-10px" alt="">
                                        <div class="p-3 text-center
                                        ">
                                            <h4 class="mb-0">Jeffery Mussman</h4>
                                            <p class="mb-2">Founder &amp;  CEO</p>
                                    ...
                                    <div class="col-lg-3">
                                        <img src="/site_asset/images/team/4.webp" class="img-fluid rounded-10px" alt="">
                                        <div class="p-3 text-center
                                        ">
                                            <h4 class="mb-0">Jeffery Mussman</h4>
                                            <p class="mb-2">Founder &amp;  CEO</p>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-2 text-center">
                                <div class="bg-color-3 inline-block w-25 p-3 py-4 rounded-10px m-2 wow fadeInUp" data-wow-delay=".0s">
                                    <img src="/site_asset/images/logo/1.webp" class="img-fluid">
                                </div>
                                <div class="bg-color-3 inline-block w-25 p-3 py-4 rounded-10px m-2 wow fadeInUp" data-wow-delay=".2s">
                                    <img src="/site_asset/images/logo/2.webp" class="img-fluid">
                                </div>
...
@include('web_includes.footer')
    ...
    <script src="/site_asset/form.js"></script>
    <script src="/site_asset/recaptcha.js"></script>
