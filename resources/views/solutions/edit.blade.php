                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title"><a class="btn btn-info waves-effect waves-light"
                                            href="/solutions"><i class="dripicons-arrow-thin-left"></i></a></h4><br>


                                            <form class="row needs-validation"
                                            action="{{ route('solutions.update', $solution->id) }}"
                                            method="POST"
                                          ...
                                          <div class="mb-3 position-relative">
                                              ...
                                              <select name="type"
                                                      ...
                                                      required>
                                                  <option value="Challenges" {{ $solution->type === 'Challenges' ? 'selected' : '' }}>Challenges</option>
                                                  <option value="Solution" {{ $solution->type === 'Solution' ? 'selected' : '' }}>Solution</option>
                                                  <option value="Feature" {{ $solution->type === 'Feature' ? 'selected' : '' }}>Feature Texts</option>
                                              </select>
                                          </div>
                                          ...
                                          <div class="mb-3 position-relative">
                                              ...
                                              <div>
                                                  <textarea name="content"
                                                            class="form-control"
                                                            rows="10"
                                                            required>{{ old('content', $solution->content) }}</textarea>
                                              </div>
                                          </div>
                                          ...
                                          <div class="mb-0">
                                              <div>
                                                  ...
                                                  <a href="{{ route('solutions.index') }}" class="btn btn-secondary waves-effect ms-1">
                                                      Cancel
                                                  </a>
                                              </div>
                                          </div>
