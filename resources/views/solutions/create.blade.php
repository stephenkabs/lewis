                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="row needs-validation" action="{{ route('solutions.store') }}"
                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <select type="text" name="type" class="form-select" id="validationCustom01"
                                                ...
                                                <option value="Feature">Feature Texts</option>
                                                <option value="business">VM Business</option>
                                                <option value="business_section">VM Business Sections</option>
