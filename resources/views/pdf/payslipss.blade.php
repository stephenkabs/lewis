...
<head>
    ...
    <title>{{ $payslip->worker->name }} - PDF Export</title>
...
<body style="font-size: 13px; font-family: 'Courier Regular', Courier, monospace;">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">{{ $payslip->salary->worker->name }}'s Payslip Information</h4>
                        <hr style="border-top: dashed 1px;" />

                        <!-- Payslip Details -->
                        <div class="row">
                            <div class="col-md-6">
                                <p><strong>Employee Name:</strong> {{ $payslip->salary->worker->name }}</p>
                                <p><strong>Position:</strong> {{ $payslip->salary->worker->designation }}</p>
                                <p><strong>Department:</strong> {{ $payslip->salary->worker->department->name }}</p>
...
{{--
                                ...
                                <p> <b>Advance Amount Cut: ({{ formatCurrency($totalAdvance) ?? 'No Advance Cut' }})</p>
                            </div>
                        </div>
