                                    ...
                                    <form class="row needs-validation" action="{{ route('accounts.store') }}" novalidate
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <div>
                                                    <input name="sort_code" type="text" class="form-control"
                                        ...
                                        <div class="row">
                                            <!-- Currency -->
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label" for="validationCustom01">Account
                                                    Currency</label>
                                                <select name="currency" class="form-select" id="validationCustom01"
                                                    required>
                                                    <option value="" disabled selected>Select Currency</option>
                                                    <option>Kwacha Account</option>
                                                    <option>US Dollar Account</option>
                                                </select>
                                            </div>
                                        ...
                                        <input name="type" type="hidden" value="Online Paymenet"
                                        />
                                        <div class="row">
                                            <!-- Branch -->
                                            <div class="mb-3 col-md-6">
                                            ...
                                            {{-- <input name="branch" type="hidden" class="form-control"
                                                value="Online Banking" /> --}}
                                            <!-- Account Type -->
                                            <!-- Target -->
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label" for="validationCustom01">Accounts
                                                    For</label>
                                                <select name="target" class="form-select" id="validationCustom01"
                                                    required>
                                                    <option value="" disabled selected>Select Description
                                                    </option>
                                                    <option>Main</option>
